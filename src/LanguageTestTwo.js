		...
		<div className="language-test-container">
			<section className="sub-question-container">
				...
				<h4 className="sub-question-text">
					...
					people ____ Scotland speak a different language called Gaelic. There
					are ____ five million people in Scotland, and Edinburgh is ____ most
					famous city. Scotland has many mountains; the highest one is called
					'Ben Nevis'. In the south of Scotland, there are a lot of sheep. A
					long time ago, there ____ many forests, but now there are only a ____.
