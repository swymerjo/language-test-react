...
export default function LanguageTestTwo(scoreTwo) {
		...
		<div className="language-test-container">
			<section className="sub-question-container">
				...
				<h4 className="sub-question-text">
					Alice Guy Blaché Alice Guy Blaché was the first female film director.
					She first became involved in cinema whilst working for the German Film
					Company in the late 1890s. This was a period of great change in the
					cinema and Alice was the first to use many new inventions, ____ sound
					and color. In 1907 Alice ____ to New York where she started her own
					film company. She was ____ successful, but, when Hollywood became the
					center of the film world, the best days of the independent New York
					film companies were ____. When Alice died in 1968, hardly anybody ____
					her name.
				</h4>
			</section>
